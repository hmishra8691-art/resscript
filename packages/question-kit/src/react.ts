...
export {
  matrixSideBySide,
  MatrixSideBySideEditor,
  MatrixSideBySideRenderer,
} from './plugins/matrix-side-by-side/react.js';
...
import { matrixSideBySide } from './plugins/matrix-side-by-side/react.js';
